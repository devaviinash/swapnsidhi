    ...
    <div className="relative min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-saffron-50 via-white to-gold-50">
          ...
          <div
            className="absolute -right-40 bottom-20 h-96 w-96 rounded-full bg-gold-400/5 blur-3xl animate-pulse"
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h1
              className="font-playfair text-4xl font-bold md:text-5xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-saffron-700 to-gold-700 animate-fadeIn"
              style={{ animationDelay: "0.3s" }}
            >
              Our Mission
            </h1>
            <p className="mt-6 text-lg text-stone-600">
              Swapnasiddhi is dedicated to empowering the Maratha community by
              connecting aspiring professionals with experienced mentors,
              fostering growth, and preserving our rich cultural heritage while
          ...
          <div className="mx-auto grid max-w-5xl gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-4 text-stone-600">
                We envision a future where every member of the Maratha community
                has access to mentorship, guidance, and opportunities to achieve
                their full potential. Through technology and community
                connections, we aim to create a powerful network that uplifts
            ...
            <div>
              ...
              <div className="mt-4 space-y-4">
                {values.map((value) => (
                  <div
                    key={value.title}
                    className="rounded-lg border border-saffron-200/20 bg-white/50 p-4 backdrop-blur-sm"
                  >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-stone-600">
              We are a dedicated team of professionals committed to building
              bridges between experienced mentors and ambitious mentees within
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl rounded-2xl border border-saffron-200/20 bg-white/50 p-8 text-center backdrop-blur-sm">
            ...
            <p className="mt-4 text-stone-600">
              Have questions about Swapnasiddhi? We'd love to hear from you and
...
const values = [
  {
    ...
    description:
      "We prioritize the needs and aspirations of the Maratha community in everything we do.",
  },
  {
    title: "Excellence",
    description:
      "We strive for excellence in our platform and encourage the same in our mentors and mentees.",
  },
  {
    title: "Cultural Pride",
    description:
      "We celebrate and preserve our rich Maratha heritage while embracing modern opportunities.",
  },
  {
    title: "Empowerment",
    description:
      "We believe in empowering individuals through knowledge sharing and meaningful connections.",
  },
];
