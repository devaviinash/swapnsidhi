    ...
    switch (currentStep) {
      ...
      case 2:
        return (
          <>
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-700" htmlFor="expertise">
                Area of Expertise
              </label>
              <select
                id="expertise"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-700" htmlFor="experience">
                Years of Experience
              </label>
              <input
                id="experience"
          ...
          <>
            <div className="space-y-2">
              ...
              <textarea
                id="bio"
                rows={4}
                placeholder="Tell us about your professional journey and mentoring experience"
                required
                className="w-full rounded-md border border-saffron-200 bg-white px-3 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-saffron-500 focus:ring-offset-2"
              />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-stone-700" htmlFor="linkedin">
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Share your expertise and make a lasting impact on the next generation.&rdquo;
            </p>
          </blockquote>
        </div>
      </div>
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <div className="flex flex-col space-y-2 text-center">
            ...
            <p className="text-sm text-stone-500">
              Step {currentStep} of 3: {currentStep === 1 ? "Basic Information" : currentStep === 2 ? "Professional Details" : "Additional Information"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              {currentStep > 1 && (
                <button
                  type="button"
                  className="text-stone-600 hover:text-stone-900 px-4 py-2 rounded-md transition-colors"
